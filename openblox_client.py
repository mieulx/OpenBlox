...
ROBLOX_SYSTEM = (
    ...
    "- RESPONSE LENGTH LIMIT: Maximum 200-300 lines per response.\n"
    "- For large tasks (entire game systems), split into multiple responses.\n"
    "- Output the full plan first, then execute ONE part per response.\n"
    "- Never output more than 300 lines in a single response.\n"
    "- If you hit the limit, say 'Continuing in next response...' and stop.\n"
    "\n"
